...
let bottlesOfBeer = "";
for (let b = 99; b <= 99;){
    bottlesOfBeer = b + " bottles of beer on the wall, " + b + " bottles of beer. Take one down, pass it around, " + (b-1) + " bottles of beer on the wall." + "<br>";
    document.getElementById("beer").innerHTML = bottlesOfBeer;
    b--;
}
...
document.getElementById("for-in").innerHTML = mnths;
...
document.getElementById("for-of").innerHTML = fname;
